...
module.exports = class RippleConnector extends LedgerConnector {
    ...
    async checkAccountBalance(currentTransConst) {
        try {
            ...
            return this._log.warn("Getting account info failure - There is possibility of not having enough XRP for transaction fee. Try catch block message: " + err.message.toString());
        }
